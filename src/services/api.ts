...
export interface Writer { id: number; nombre: string; apellido: string;
nacionalidad: string; edad: number; books: any[]; }
export interface Book { id: number; nombre: string; genero: string;
...
export const createBook = (b: { nombre: string; genero: string;
